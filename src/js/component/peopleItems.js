...
export const PeopleItem = (props) => {
	...
	return (
        <div>
        <div>
        <div className="card cardItem mb-5">
            <img 
            src="https://cherry-brightspot.s3.amazonaws.com/d3/52/3cce57164534a50d08dfb1b8ace7/original.jpg" 
            ...
            <div className="card-body">
                ...
                <div className="d-flex justify-content-between">
                    <Link to={`/person/${props.person.uid}`} className="btn btn-warning">Learn more</Link>
